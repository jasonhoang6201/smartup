...
const Cart = (props: Props) => {
            ...
            render: (_: string, record: any) => (
                <div className="product-info">
                    <div className="product-image">
                        <img src={record.thumbnail} alt="product" height={100} />
                    </div>
    ...
    useLayoutEffect(() => {
        setSubTotal(data.reduce((acc, item) => acc + item.price * item.quantity, 0))
    }, [data])
    ...
    return (
        <div className="cart">
            ...
            <div className="checkout">
                ...
                <button className="btn" onClick={() => setIsCheckoutModal(true)}>Checkout</button>
            </div>

            <ModalCheckout visible={isCheckoutModal} onCancel={() => setIsCheckoutModal(false)} />
        </div>
    )
}
